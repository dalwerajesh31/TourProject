      ...
      <h2 style={{ textAlign: 'center', color: 'red' }}>Registration Form</h2>
        ...
        <Row className="mb-3">
          <Col>
            ...
            <Form.Control type="text" name= "userName" placeholder="First name" onChange={handleChange} required />
          </Col>

          <Col>
            <Form.Label class="green-label">Create Password</Form.Label>
            <Form.Control type="text" name= "passWord" placeholder="Last name" onChange={handleChange} required />
          </Col>
        </Row>
